...
EXTERNAL NAME 'CLASSPATH:com.csg.cs.aura.core.domain.base.UUIDGenerator.next'
;

------- CreateDDL statement separator -------
CREATE FUNCTION sys_context(namespace varchar(255), param varchar(255)) RETURNS varchar(255)
LANGUAGE JAVA DETERMINISTIC NO SQL
EXTERNAL NAME 'CLASSPATH:com.csg.cs.aura.core.domain.base.DBHelper.getSysContext'
;
...
AS 'com.csg.cs.aura.core.domain.base.UUIDGenerator.next'
LANGUAGE java;
